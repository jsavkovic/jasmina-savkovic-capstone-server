  ...
  return knex('item').del()
    .then(function () {
      ...
      return knex('item').insert([
        ...
        { id: 2, name: 'High Chair', description: 'A high chair for feeding', status_id: 1, type_id: 2, image: 'high_chair.jpg', category_id: 2, user_id: 2, created_at: knex.fn.now(), updated_at: knex.fn.now() },
        ...
        { id: 9, name: 'Educational Toys', description: 'Educational toys for learning', status_id: 1, type_id: 5, image: 'educational_toys.jpg', category_id: 1, user_id: 9, created_at: knex.fn.now(), updated_at: knex.fn.now() },
        { id: 10, name: 'Books', description: 'Books for kids', status_id: 1, type_id: 12, image: 'books.jpg', category_id: 1, user_id: 10, created_at: knex.fn.now(), updated_at: knex.fn.now() },
        { id: 11, name: 'Diaper Bag', description: 'A spacious diaper bag', status_id: 1, type_id: 3, image: 'diaper_bag.jpg', category_id: 1, user_id: 1, created_at: knex.fn.now(), updated_at: knex.fn.now() },
        ...
        { id: 17, name: 'Bath Toys', description: 'Fun bath toys for babies', status_id: 1, type_id: 6, image: 'bath_toys.jpg', category_id: 1, user_id: 7, created_at: knex.fn.now(), updated_at: knex.fn.now() },
        ...
        { id: 23, name: 'Puzzle Set', description: 'A set of educational puzzles', status_id: 1, type_id: 12, image: 'puzzle_set.jpg', category_id: 1, user_id: 3, created_at: knex.fn.now(), updated_at: knex.fn.now() },
        { id: 24, name: 'Flashcards', description: 'Educational flashcards', status_id: 1, type_id: 12, image: 'flashcards.jpg', category_id: 1, user_id: 4, created_at: knex.fn.now(), updated_at: knex.fn.now() },
